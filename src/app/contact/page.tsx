...
const BRANCHES: Branch[] = [
  {
    ...
    colorClass: "border-l-brand-pink"
  },
  {
...
export default function ContactPage() {
  return (
    <div className="flex flex-col w-full relative bg-clinic-bg text-clinic-dark pb-24">
      ...
      <section className="py-20 max-w-7xl mx-auto px-6 w-full animate-fade-in">
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-16 items-start">
          ...
          <div className="flex flex-col gap-10">
            <div>
              <span className="text-[10px] font-bold uppercase tracking-widest text-brand-pink">General Coordinates</span>
              <h2 className="text-3xl font-serif font-bold text-white tracking-wide mt-3">
            ...
            <div className="flex flex-col gap-6">
              {[
                { 
                  icon: <Phone className="w-5 h-5 text-brand-pink" />, 
                ...
                <div key={idx} className="glass-panel p-6 bg-[#08090d]/60 border-slate-800/60 rounded-2xl flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-semibold text-white mt-1">{coord.detail}</p>
          ...
          <div className="flex flex-col gap-8">
            <div>
              <span className="text-[10px] font-bold uppercase tracking-widest text-brand-pink">Clinic Locations</span>
              <h2 className="text-3xl font-serif font-bold text-white tracking-wide mt-3">
            ...
            <div className="flex flex-col gap-4">
              {BRANCHES.map((branch, idx) => (
                <div 
                  key={idx} 
                  className={`glass-panel p-6 rounded-2xl border-l-[4px] ${branch.colorClass} bg-[#08090d]/60 border-slate-800/60 shadow-md flex items-start gap-4 hover:border-brand-pink/40 transition-all duration-300`}
                >
                  <MapPin className="w-5 h-5 text-slate-500 shrink-0 mt-0.5" />
                  <div>
                    <h4 className="font-serif text-[15px] font-bold text-white">{branch.name}</h4>
                    <p className="text-[10px] font-bold text-brand-gold uppercase tracking-wider mt-0.5">{branch.type}</p>
      ...
      <section className="py-20 bg-[#08090d]/30 border-t border-slate-900/60 relative z-10" id="booking">
